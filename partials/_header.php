...
<?php
session_start();
echo '<nav class="navbar navbar-expand-lg navbar-dark bg-dark"  style="background: linear-gradient(to right, #ffac2f, #ff1765, #fa619b ); ">
<img src="img/kk.jpg" width="54px" style="border-radius: 50px;" width="40px" class="mr-3" alt="">
<a class="navbar-brand" href="/forum">K-30</a>
